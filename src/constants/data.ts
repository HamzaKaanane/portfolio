...
export const myProjects = [
  ...
  },
  {
    ...
    logoStyle: {
      ...
      background:
        "linear-gradient(0deg, #172a8950, #A0F0BC50), linear-gradient(180deg, rgba(255, 255, 255, 0.95) 0%, rgba(97, 133, 192, 0.85) 100%)",
      border: "0.2px solid rgba(160, 171, 240, 1)",
...
export const socialLinks = [
  { url: "https://www.instagram.com/h1mza.xyz/" },
  { url: "https://github.com/HamzaKaanane" },
  { url: "https://www.linkedin.com/in/hamza-kaanane-051860347/" },
];
